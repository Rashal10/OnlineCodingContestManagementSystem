...
interface Contest { contest_id: number; title: string; description: string; start_time: string; end_time: string; status: "UPCOMING" | "ONGOING" | "ENDED"; }
  ...
  return (
    <div>
      ...
      <div className="table-wrap">
        <table>
          <thead><tr><th>Name</th><th>Status</th><th>Time</th><th>Start</th><th>End</th><th>Action</th></tr></thead>
          <tbody>
            {contests.length === 0 ? <tr><td colSpan={6}>No contests found.</td></tr> :
              contests.map((c) => (
                <tr key={c.contest_id}>
